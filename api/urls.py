...
from .views import AllWrappedView, CreateWrapView, WrappedView, GetFirstVideo, GetMonthsCats, CheckUser, OnRepeat, TopChannels, LongestVideo
...
urlpatterns = [
    ...
    path('longest-old', LongestVideo.as_view()),    
]