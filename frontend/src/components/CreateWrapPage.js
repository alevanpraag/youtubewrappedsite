...
export default function CreateWrapPage(props) {
  ...
  function handleNameChange(e) {
    ...
    if (/[^\w]/.test(e.target.value)){
      setErrorText("Only numbers and letters")
    } else if (chars>=8){
  ...
  function renderError(){
    if (!error){
      return (<h4 style={{ color: "#94D2BD" }}>  Give us a nickname and upload your YouTube watch history</h4>);
    }
    return (
      <em style={{ color: "#EE9B00" }}> Something went wrong... please upload a valid file</em>
    );
  }
  function goToWrap(){
    if (code != null){
  ...
  function renderForm(){
    return (
      <Grid className="center" container spacing={1}>
        ...
        <Grid item xs={1} align="center"></Grid>
        <Grid item xs={1} align="center"></Grid>
        <Grid item xs={10} align="center" display="flex" alignItems="center" justifyContent="center" gap={1}>
          <h4 style={{ color: "#AE2012" }}> Please request your watch history from your Google account </h4>   
        ...
        <Grid item xs={12} align="center" display="flex" alignItems="center" justifyContent="center">
          <FormControl>
              <input
                name="name"
                id="name"
  ...
  function renderCreateButton(){
    if ((file == null) || (!name) || loading || (errorText == "Only numbers and letters")){
      return null;
    }
    return (
      <Grid item xs={12} align="center">
