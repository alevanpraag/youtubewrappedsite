...
function handlePreviousPressed() {
  ...
  function renderError(){
    ...
    return (
      <><br/><em style={{ color: "#EE9B00" }}> Something went wrong... please upload a valid file</em></>
    );
  }
  function goToWrap(){
    if (code != null){
    ...
    return (
      <Grid className="center" container spacing={1}>
        ...
        <Grid item xs={10} align="center" display="flex" alignItems="center" justifyContent="center" gap={1}>
          <h4 style={{ color: "#EE9B00" }}> Please request your watch history from your Google account </h4>   
