...
export default function FourthWrapPage(props){
    ...
    <header>
      ...
      <Grid item xs={12} align="center">
      <h6> <span style={{ color: "#EE9B00", fontSize: "2rem", fontFamily: 'Orbitron' }}>{cat} </span> with <span style={{ color: "#0A9396", fontSize: "2rem", fontFamily: 'Orbitron' }}>{countC} </span> videos</h6>      
      </Grid>                                 
    </Grid>
      </section>  
